...
function testParameters()
	train = "foursquare_train.csv";
	test = "foursquare_test.csv";
	prefix = "res/foursquare/old-data/"
	learning_rate_list = [0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4];
	decay_rate_list = [0.75, 0.8, 0.85, 0.9, 0.95, 1];
...
function findLrDr()
	train = "foursquare_train1.csv";
	test = "foursquare_test1.csv";
	prefix = "res/foursquare/"
...
# findLrDr();
io = open("t.txt","w")
main("foursquare_train.csv", "foursquare_test.csv", 0.35, 0.95, 1, 6, 30, 3, io)